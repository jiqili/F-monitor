...
var ErrorBoundary = /** @class */ (function (_super) {
    ...
    ErrorBoundary.prototype.componentDidCatch = function (error, errorInfo) {
        ...
        this.props.children.map(function (item) {
            var _a, _b;
            if ((_a = item === null || item === void 0 ? void 0 : item.type) === null || _a === void 0 ? void 0 : _a.name)
                componentName.push((_b = item === null || item === void 0 ? void 0 : item.type) === null || _b === void 0 ? void 0 : _b.name);
        });
        // 将错误日志上报给服务器
        emit({
            type: 'Error',
...
var ReactBoundary = ErrorBoundary; //导出错误边界
...
export { ReactBoundary, initMonitor };
